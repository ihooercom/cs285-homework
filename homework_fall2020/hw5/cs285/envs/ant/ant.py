...
class AntEnv(mujoco_env.MujocoEnv, utils.EzPickle):
    ...
    def step(self, action):
        ...
        #return
        env_info = {'time': self.time, 'obs_dict': self.obs_dict, 'rewards': self.reward_dict, 'score': score}
    ...
    def reset_model(self, seed=None):
        ...
        # set reset pose/vel
        self.reset_pose = self.init_qpos + self.np_random.uniform(low=noise_low, high=noise_high, size=self.model.nq)
